...
function reducer(state, action) {
  switch (action.type) {
    ...
    case 'restart':
      return {
        ...state, index: 0, answer: null, status: 'ready',
    ...
    <div className='app'>
      ...
      <Main >
        ...
        {status === 'ready' && <StartScreen
          numOfQues={numOfQues} dispatch={dispatch} />}

        {status === 'active' && (
          <>
            <Progress numOfQues={numOfQues} index={index}
              points={points} maxPossiblePoints={maxPossiblePoints}
              answer={answer}
            />

            <Question que={questions[index]} dispatch={dispatch}
              answer={answer} />
            ...
            <Footer>
              ...
              <NextButton dispatch={dispatch} answer={answer}
                index={index} numOfQues={numOfQues} />
            </Footer>
          </>)
        }
